package com.stematel.daffa.myintentapp
...
import com.stematel.daffa.myintentapp.MoveActivity
import com.stematel.daffa.myintentapp.R
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_move_activity_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "DaffaAbhi");
